			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form 0 action="checkout.php" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/Ecommerce-master/payment_success.php"/>
									...
									<input style="float:right;margin-right:80px;background-color:#007bff;color:white; font-size:25px; width:200px; height:50px; border-radius: 12px;" type="submit" name="submit" value="Check out"
								 >
								</form>';
				}
			}
